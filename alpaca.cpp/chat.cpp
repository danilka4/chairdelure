    ...
    while (remaining_tokens > 0) {
        ...
        if (params.interactive && embd_inp.size() <= input_consumed) {
            ...
            if (is_interacting) {
                ...
                char DANIEL_PROMPT[] = "My name is Daniel and I am a CMDA + CS major minoring in PSCI. Outside college I work as a part-time math teacher and tutor, and within VT my research is analyzing state lobbying efforts with regards to climate legislation. I have an interest in anarchist theory. Outside politics and school I enjoy playing Magic: the Gathering and Dungeons and Dragons, as well as tinkering with Linux on my computer. I enjoy writing documents in LaTeX and vim. I really enjoy the soda cheerwine. ";
                std::vector<gpt_vocab::id> line_inp = ::llama_tokenize(vocab, DANIEL_PROMPT, false);
